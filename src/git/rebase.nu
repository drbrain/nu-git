...
def rebase_merges [] {
  [
    { value: "rebase-cousins", description: "Rebase commits from another upstream onto <upstream>" },
    { value: "no-rebase-cousins", description: "Leave cousin commits with their original ancestry" },
  ]
}
...
export extern "git rebase" [
  ...
  --strategy(-s): string@strategy           # Use the given merge strategy instead of the default of ort
  ...
  --whitespace: string@whitespace           # Detect a new or modified line with whitespace errors (see git-apply)
